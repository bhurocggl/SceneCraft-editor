    ...
    <div className="w-72 bg-gray-800 p-4 flex flex-col h-full overflow-y-auto border-l border-gray-700">
      ...
      <div className="mt-4 pt-4 border-t border-gray-700">
        <button
          ...
          className="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:bg-gray-500 disabled:cursor-not-allowed"
        >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" />
                <path d="M6 3a2 2 0 012-2h4a2 2 0 012 2v2a2 2 0 01-2 2H8a2 2 0 01-2-2V3z" />
                <path d="M9 11a1 1 0 012 0v1a1 1 0 11-2 0v-1z" />
                <path d="M4 5a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 012 0v1a1 1 0 11-2 0V9zm4 0a1 1 0 012 0v1a1 1 0 11-2 0V9z" />
            </svg>
          Save Scene
        </button>
      </div>
